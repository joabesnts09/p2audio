...
export const AudioCard = ({
    ...
    // Função para retornar o ícone SVG baseado no tipo (versão compacta)
    const getTypeIcon = () => {
    ...
    return (
        <motion.div
            ...
            className="bg-white rounded-lg p-4 border border-gray-200 hover:border-gold-yellow transition-all duration-300 hover:shadow-md group"
        >
            {/* Layout compacto horizontal */}
            <div className="flex items-start gap-4">
                {/* Ícone pequeno à esquerda */}
                <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-gold-yellow/20 to-gold-yellow/10 flex items-center justify-center">
                    {coverImage ? (
                        <img
                            src={coverImage}
                            alt={title}
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-start justify-between gap-2 mb-2">
                        <div className="flex-1 min-w-0">
                            {type && (
                                <span className="inline-block px-2 py-0.5 bg-gold-yellow/20 text-black text-xs font-semibold rounded mb-1">
                                    {type}
                                </span>
                            )}
                ...
                />
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                onClick={togglePlay}
                                className="flex-shrink-0 w-8 h-8 rounded-full bg-gold-yellow hover:bg-gold transition-colors flex items-center justify-center text-black"
                            ...
                            <button
                                onClick={toggleMute}
                                className="w-7 h-7 flex items-center justify-center text-gray-500 hover:text-black transition-colors flex-shrink-0"
